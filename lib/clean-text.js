...
var CleanText = exports.CleanText = (function () {
  function CleanText() {
    var opts = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];
    (0, _classCallCheck3.default)(this, CleanText);
    ...
    this.separators = opts.separators || ['0009', // character tabulation
    '000A', // line feed
    ...
    var splitCharacters = this.separators.map(function (s) {
      return '\\u' + s;
    }).join('');
    this.pattern = new RegExp('[ :\\s' + splitCharacters + ']+', 'g');
  }

  (0, _createClass3.default)(CleanText, [{
    key: 'keepText',
    value: function keepText(text, cb) {
      var finalResult = text.replace(/(?:\t|\r|\n)+/g, ' ').replace(/\s+/g, ' ');
    ...
    key: 'keepWords',
    value: function keepWords(text, cb) {
...
var singletonInstance = new CleanText({});
var singletonMethod = function singletonMethod(input, opts) {
  return singletonInstance.cleanText(input, opts);
};
